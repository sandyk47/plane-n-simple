...
contract Cryptos is ERC20Interface{
    string public name = "PlaneTokens";
    string public symbol = "PLNS";
...
contract CryptosICO is Cryptos{
    ...
    uint public saleEnd = block.timestamp + 1 weeks; //one week
    
    uint public tokenTradeStart = saleEnd + 1 weeks; //transferable in a week after saleEnd
